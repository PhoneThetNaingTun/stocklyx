...
import { useArchiveMeasurementUnitMutation } from "@/store/Apis/measurementUnitApi";
...
import { UpdateMeasurementUnitDialog } from "./UpdateMeasurementUnitDialog";

interface Props {
  data: MeasurementUnit;
}

export const MeasurementUnitCellAction = ({ data }: Props) => {
  const [open, setOpen] = useState(false);
  const [deleteOpen, setDeleteOpen] = useState(false);
  const [Archive, { isLoading }] = useArchiveMeasurementUnitMutation();
