...
export const ArchiveSupplierCellAction = ({ data }: Props) => {
  const [open, setOpen] = useState(false);
  const [deleteOpen, setDeleteOpen] = useState(false);
  const [Delete, { isLoading }] = useDeleteSupplierMutation();
  const [Restore, { isLoading: RestoreLoading }] = useRestoreSupplierMutation();
